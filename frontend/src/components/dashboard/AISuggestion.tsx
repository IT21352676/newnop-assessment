...
import { saveAiSuggestion } from "@/lib/api";
        ...
        <div className="bg-bg-deep/50 p-4 rounded-xl border border-primary/20">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              {triageResult && !triageResult?.isUnclear && (
                <button
              ...
              {aiSuggestion?.suggestions?.jsonContent && (
          ...
          {triageResult ? (
            ...
            <TriageReport data={aiSuggestion.suggestions.jsonContent} />
          ) : (
